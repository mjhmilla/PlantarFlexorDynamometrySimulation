...
switch flag_preloadSetting
  case 1
    simDataSets = {...
      ['../data/simFv_gasmed_preload_0p_',architectureStr,modelName,...
        scaleLceOptStr,...            
        vmaxStr,...  
        rampStr,...
        fractionOfFastTwitchFibersStr,...
      ...
      ['../data/simFv_gasmed_preload_100p_',architectureStr,modelName,...
        scaleLceOptStr,...            
        vmaxStr,...  
        rampStr,...
        fractionOfFastTwitchFibersStr,...
  ...
  case 2
    simDataSets = {...
      ...
      ['../data/simFv_gasmed_preload_100p_',architectureStr,modelName,...
        ...
        ankleAchillesTendonMomentArmStr,...
        measurementSettingStr,'.mat'],...
      ['../data/simFv_gasmed_preload_50p_',architectureStr,modelName,...
        scaleLceOptStr,...            
        vmaxStr,...  
        rampStr,...
        fractionOfFastTwitchFibersStr,...
...
%%
    ...
    fill([0;-measuredFiberVelocityAlongTendonRef;-measuredFiberVelocityAlongTendonRef(end)].*m2mm,...
         [0;measuredForceVelocityMultiplierAlongTendonRef;0].*scaleNormForce,...
         [1,1,1].*0.9,...
         'LineStyle','none',...
    ...
    for i=1:1:length(simDataSets)
      ...
      for j=1:1:trials
        ...
        %%
          ...
          if(i==1)
            ht=text(180,0,'$$\frac{\mathbf{f}^V(\tilde{v}^{CE})\cos \alpha}{\cos \alpha_\circ}$$',...
