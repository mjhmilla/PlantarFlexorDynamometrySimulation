...
tendonStrainAtOneNormForceOverride = 0.049;
 %%
...
for count=1:1:countMax
    ...
    initialHoldTime              = 0.2;   %Initial time [s] at the starting angle
    ...
    ankle_angularVelocity(:,count)= ...
      ankleAchillesTendonMomentArm.*benchRecordDampedFiberElasticTendon.pathVelocity;
...
if(countMax > 2)
  ...
  legendEntry = sprintf('Tendon eIso (%1.3f)',tendonStrainAtOneNormForceOverride);
