...
detailedResultsStruct = struct('ankleAngularVelocity',zeros(npts,countMax),...
                         'simulationTime',zeros(npts,countMax),...
                         'measurementTime',zeros(1,countMax),...
...
for count=1:1:countMax
    ...
    if(flag_runRigidBench == 1)
        ...
        rigidTendonSimulationRecord.detailedResults.measurementTime(1,count) = measurementTime;
